...
const Home = () => {
  ...
  const categories = [
    ...
    { name: "Finance", icon: "💰", count: 19 },
    { name: "Manufacturing", icon: "🏭", count: 15 },
    { name: "Tourism", icon: "🏖️", count: 12 },
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="bg-white rounded-xl p-6 text-center border-2 border-primary">
              ...
              <p className="text-2xl font-bold text-primary mb-2">$6.25/month</p>
            ...
            <div className="bg-white rounded-xl p-6 text-center">
              ...
              <p className="text-2xl font-bold text-primary mb-2">$12.50/month</p>
